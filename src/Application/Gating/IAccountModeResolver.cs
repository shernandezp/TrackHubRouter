...
/// </summary>
public interface IAccountModeResolver
{
    Task<bool> IsIntegrationEnabledAsync(Guid accountId, CancellationToken cancellationToken);
    Task<bool> IsPositionHistoryEnabledAsync(Guid accountId, CancellationToken cancellationToken);
}
