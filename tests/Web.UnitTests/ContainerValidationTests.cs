...
using TrackHub.Router.Web.Endpoints;
...
public sealed class ContainerValidationTests
{
    ...
    private sealed class RouterFactory : WebApplicationFactory<Devices>
    {
        protected override IHost CreateHost(IHostBuilder builder)
        {
            ...
            // service — here that would share one provider session across concurrent requests.
    ...
    {
        using var factory = new RouterFactory();
